...
def test_piotroski_full_score():
    ...
    strong = {
        "net_income": 100,
        "roa": 10,
        "cfo": 150,  # profitable, cash-backed
        "debt_to_assets": 0.2,
        "debt_to_assets_prev": 0.3,  # deleveraging
        "current_ratio": 2.0,
        "current_ratio_prev": 1.5,  # more liquid
        "shares": 100,
        "shares_prev": 100,  # no dilution
        "gross_margin": 40,
        "gross_margin_prev": 35,  # margin up
        "asset_turnover": 1.2,
        "asset_turnover_prev": 1.0,  # turnover up
    }
...
def test_yield_formulas():
    ...
    r = {"ebit": 20, "market_cap": 100, "cfo": 15, "capex_history": [5], "dividend_history": [-3]}
